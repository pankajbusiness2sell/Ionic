...
@Component({
  selector: 'app-gaurantee',
  templateUrl: './gaurantee.page.html',
  styleUrls: ['./gaurantee.page.scss'],
})
export class GauranteePage implements OnInit {
  ...
  ngOnInit() {
    ...
    getBeforeImages() {
      ...
      //#### THIS IS STAFF ID
      dashboardPost.job_image_type = "guarantee";
    ...
    async uploadBefore() {
        ...
        .then(async (result) => {
            ...
            //   title: 'Bcic',
            //   text: 'Bcic notifies you about your job#6651 is ready to start at 8:00 Am morning. Ty',
